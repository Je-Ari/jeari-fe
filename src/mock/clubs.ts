...
export const clubs: Club[] = [
  { id: 1, name: '꼬물락', description: '꼬물락도 락이다 - 뜨개질 동아리', isRecruiting: true, tags: ['예술', '공예'] },
  ...
  { id: 6, name: '코딩 동아리', description: '함께 배우고 성장하는 코딩 동아리입니다.', isRecruiting: true, tags: ['IT', '코딩'] },
];
